{extends file="parent:widgets/emotion/components/component_youtube.tpl"}
        ...
        {if $Data && $Data.video_id}
            ...
            {if !$Data.video_autoplay}
                <div class="yt--lazyload-plugin">
                    <img 
                        class="yt-img" 
                        src="//img.youtube.com/vi/{$Data.video_id}/hqdefault.jpg" 
                        onclick="ytLazyLoad(this)" 
                        data-url="{$Data.video_id}{if $params}{$params}{/if}"
                        />
                    <i class="yt-icon material-icons">play_circle_filled</i>
                    <i class="yt-icon material-icons">play_circle_filled</i>
                </div>
            {* If Autoplay *}
            {else}
                <iframe class="external--content content--youtube xyz"
                        width="100%"
                        height="100%"
